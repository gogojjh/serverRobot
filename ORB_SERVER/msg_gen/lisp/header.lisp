...
(cl:defmethod cl:initialize-instance :after ((m <header>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'header)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ORB_CLIENT-msg:<header> is deprecated: use ORB_CLIENT-msg:header instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <header>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ORB_CLIENT-msg:header-val is deprecated.  Use ORB_CLIENT-msg:header instead.")
  (header m))
