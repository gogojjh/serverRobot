...
void LoopClosing::Run()
{
	...
	while(1)
	{
		//std::cout << "Closing Keyframe " << CheckNewKeyFrames() << std::endl;
		// Check if there are keyframes in the queue
		if(CheckNewKeyFrames())
		{
// 			std::cout << "Closing CheckNewKeyFrames" << std::endl;
			// Detect loop candidates and check covisibility consistency
			if(DetectLoop())
			{
// 				std::cout << "Closing DetectLoop" << std::endl;
				if(mpLocalMapper->GetVINSInited())
				{
					...
					if(ComputeSim3())
					{
						...
						CorrectLoop();
// 						std::cout << "Closing CorrectLoop" << std::endl;
					}
				}
			}
		}
		...
		ResetIfRequested();
// 		std::cout << "Closing ResetIfRequested" << std::endl;
	...
	SetFinish();
// 	std::cout << "Closing SetFinish" << std::endl;
}
