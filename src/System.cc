...
cv::Mat System::TrackMonoVI(const IMAGEData &image, const std::vector<IMUData> &vimu, const double &timestamp)
{
...
// 	std::cout << "TrackMonoVI ..." << std::endl;

	return mpTracker->GrabImageMonoVI(image, vimu, timestamp);
}
